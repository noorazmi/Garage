...
import com.arsalan.garage.fragments.MarineUserFragment;
import com.arsalan.garage.utils.AppConstants;

public class MarineUserActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbar(mToolbar, getString(R.string.buy_and_sale), true, Gravity.CENTER);
    ...
    private void setMenuHolderFragment() {
        ...
        MarineUserFragment fragment = new MarineUserFragment();
