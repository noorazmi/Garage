...
public class CustomTextViewArabic extends TextView {
    public CustomTextViewArabic(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public CustomTextViewArabic(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CustomTextViewArabic(Context context) {
        super(context);
        init(null);
    }
